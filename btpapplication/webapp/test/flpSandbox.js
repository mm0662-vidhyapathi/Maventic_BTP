		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#commaventicbtpapplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commaventicbtpapplication-display": {
								"semanticObject": "commaventicbtpapplication",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.maventic.btpapplication",
									"url": sap.ui.require.toUrl("com/maventic/btpapplication")
								}
							}
						}
					}
